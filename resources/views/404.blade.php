...
<!-- Mirrored from tivatheme.com/html/freshmart/page-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2019 08:03:56 GMT -->
<head>
	<!-- Basic Page Needs -->
	<meta charset="utf-8">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 page-left">
						<div class="image">
							<img class="img-responsive" src="{{url('/public/home')}}/img/404-left.png" alt="Image 404">
						</div>
						...
						<a class="btn btn-primary" href="{{route('home')}}"><i class="fa fa-home" aria-hidden="true"></i><span>Back to homepage</span></a>
					</div>
					
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 page-right">
						<div class="image">
							<img class="img-responsive" src="{{url('/public/home')}}/img/404-right.jpg" alt="Image 404">
						</div>
					</div>
				</div>
			</div>
...
<!-- Mirrored from tivatheme.com/html/freshmart/page-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2019 08:04:10 GMT -->
</html>